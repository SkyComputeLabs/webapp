...
build {
  ...
  provisioner "shell" {
    inline = [
      ...
      "sudo apt-get install -y postgresql postgresql-client postgresql-contrib apt-transport-https ca-certificates curl gnupg lsb-release openjdk-17-jdk unzip awscli git",
